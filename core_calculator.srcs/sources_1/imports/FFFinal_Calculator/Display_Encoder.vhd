...
begin
    ...
    begin
        case Sel is
            ...
            when "01" =>
                ...
                Final_OpCode <= "101";
            when "10" =>
                Final_Mag    <= Mul_Result(6 downto 0);
                Final_Sign   <= Mul_Sign;
                Final_OpCode <= "110";
            when "11" =>
                Final_Mag    <= (others => '0');
    ...
    begin
        if Sel = "11" then
            ...
            if Final_Mag >= "0111100" then
                Final_Out2 <= "0110";
                case Final_Mag is
                    when "0111100" => Final_Out1 <= "0000";
                    when "0111101" => Final_Out1 <= "0001";
                    when "0111110" => Final_Out1 <= "0010";
                    when "0111111" => Final_Out1 <= "0011";
                    when others    => Final_Out1 <= "0100";
                end case;
                
            elsif Final_Mag >= "0110010" then
                Final_Out2 <= "0101";
                case Final_Mag is
            ...
            elsif Final_Mag >= "0001010" then
                Final_Out2 <= "0001";
                case Final_Mag is
                    when "0001010" => Final_Out1 <= "0000";
                    when "0001011" => Final_Out1 <= "0001";
                    when "0001100" => Final_Out1 <= "0010";
                    when "0001101" => Final_Out1 <= "0011";
                    when "0001110" => Final_Out1 <= "0100";
                    when "0001111" => Final_Out1 <= "0101";
                    when "0010000" => Final_Out1 <= "0110";
                    when "0010001" => Final_Out1 <= "0111";
                    when "0010010" => Final_Out1 <= "1000";
                    when others    => Final_Out1 <= "1001";
                end case;
